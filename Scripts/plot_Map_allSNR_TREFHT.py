"""
Graphic showing SNR for TREFHT between ARISE and WACCM
...
cbar.set_label(r'\textbf{TREFHT [Signal-To-Noise] for 2035-2069}',fontsize=9,color='dimgrey',labelpad=1.4)  
...
plt.savefig(directoryfigure + 'Map_allSNR_TREFHT.png',dpi=300)

### Save composite for figure
directoryoutput = '/Users/zlabe/Documents/Research/SolarIntervention/Data/'
np.savez(directoryoutput + 'TREFHT-SAI_all.npz',
