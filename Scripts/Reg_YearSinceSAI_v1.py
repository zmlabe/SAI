"""
multiple linear regression for evaluating how long since 2035 (injection)
...
if land_only == True:
    saveData = seasons[0] + '_LAND' + '_GCMarise_YearsSinceSAI-MLR' + '_' + variq + '_' + reg_name  + '_' + 'NumOfGCMS-' + str(num_of_class)
elif ocean_only == True:
    saveData = seasons[0] + '_OCEAN' + '_GCMarise_YearsSinceSAI-MLR' + '_' + variq + '_' + reg_name + '_' + 'NumOfGCMS-' + str(num_of_class)
else:
    saveData = seasons[0] + '_GCMarise_YearsSinceSAI-MLR' + '_' + variq + '_' + reg_name + '_' + 'NumOfGCMS-' + str(num_of_class)
