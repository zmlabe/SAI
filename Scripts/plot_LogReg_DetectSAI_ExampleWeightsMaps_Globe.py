...
comp_t_sai_ready = weights_t_sai[yearindex,:,:]
comp_t_con_ready = weights_t_con[yearindex,:,:]
comp_p_sai_ready = weights_p_sai[yearindex,:,:]
comp_p_con_ready = weights_p_con[yearindex,:,:]
...
fig.suptitle(r'\textbf{YEAR 2045}',color='dimgrey',fontsize=35)

plt.tight_layout()
plt.subplots_adjust(hspace=-0.4,top=0.99)

plt.savefig(directoryfigure + 'LogReg_DetectSAI_ExampleWeightsMaps_Globe.png',dpi=300)
