...
for i in range(len(reg_nameq)):
    ...
    plt.fill_between(yearswaccm,minwaccm,maxwaccm,facecolor='crimson',alpha=0.5,clip_on=False)
    plt.plot(yearswaccm,meanwaccm,linestyle='-',color='crimson',linewidth=1,
    ...
    if i == 6:
        ...
        plt.yticks(np.arange(-6,6.1,1),np.round(np.arange(-6,6.1,1),2),rotation=0)
        plt.xlim([2015,2069])
        plt.ylim([-1,2.5])
    elif any([i==0,i==3]):
        ...
        plt.xticks(np.arange(2015,2080,20),[],rotation=0)
        plt.yticks(np.arange(-6,6.1,1),[],rotation=0)
        plt.xlim([2015,2069])
        plt.ylim([-1,2.5])
    elif any([i==7,i==8]):
        plt.xticks(np.arange(2015,2080,20),np.arange(2015,2080,20),rotation=0)
    ...
    plt.text(2014,2,r'\textbf{%s}' % labels[i],fontsize=11,color='k')
