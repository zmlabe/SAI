...
plt.savefig(directoryfigure + 'Predictions_DetectSAI_LAND_%s_TREFHT.png' % reg_name,dpi=300)
...
plt.savefig(directoryfigure + 'Observations_DetectSAI_LAND_%s_TREFHT.png' % reg_name,dpi=300)
