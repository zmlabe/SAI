"""
Make plot of predictions for detecting SAI using logistic regression
...
plt.text(2071,0.5,r'\textbf{%s}' % (reg_name),ha='center',va='center',
         color='dimgrey',rotation=270,fontsize=15)
# plt.ylabel(r'\textbf{Simulations}')
plt.tight_layout()

plt.savefig(directoryfigure + 'Predictions_DetectSAI_LAND_%s_TREFHT_LOGREG.png' % reg_name,dpi=300)
...
plt.savefig(directoryfigure + 'Observations_DetectSAI_LAND_%s_TREFHT_LOGREG.png' % reg_name,dpi=300)
