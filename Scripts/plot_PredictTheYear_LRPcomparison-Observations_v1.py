...
data = Dataset(directorydata + 'LRPMap_Z_Obs_WACCM.nc')
lat = data.variables['lat'][:]
lon = data.variables['lon'][:]
lrp_waccm_zq = data.variables['LRP'][:]
data.close()

data = Dataset(directorydata + 'LRPMap_E_Obs_WACCM.nc')
lrp_waccm_eq = data.variables['LRP'][:]
data.close()

data = Dataset(directorydata + 'LRPMap_IG_Obs_WACCM.nc')
lrp_waccm_ig = data.variables['LRP'][:]
data.close()

###############################################################################
### Read in LRP after training on ARISE
data = Dataset(directorydata + 'LRPMap_Z_Obs_ARISE.nc')
lrp_arise_zq = data.variables['LRP'][:]
data.close()

data = Dataset(directorydata + 'LRPMap_E_Obs_ARISE.nc')
lrp_arise_eq = data.variables['LRP'][:]
data.close()

data = Dataset(directorydata + 'LRPMap_IG_Obs_ARISE.nc')
...
plt.savefig(directoryfigure + 'PredictTheYear_LRPcomparison-Obs.png',dpi=300)