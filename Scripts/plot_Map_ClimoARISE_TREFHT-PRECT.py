"""
Graphic show climatological annual mean temperatures for ARISE
...
tempens = np.nanmean(data_temp[:,yearq,:,:],axis=1)
precens = np.nanmean(data_precip[:,yearq,:,:],axis=1)
...
barlim = np.arange(0,11,2)
label = r'\textbf{PRECT [mm/day]}'
...
plt.savefig(directoryfigure + 'Map_ClimoTempPrecip_RegionBoxes.png',dpi=1000)
